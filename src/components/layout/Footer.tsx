        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/dixonpremiergroup/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: '#9a9a9a' }} className="hover:opacity-70 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
